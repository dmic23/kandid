            ...
            source: function (request, response) {
                $.ajax({
                    ...
                    data: {
                        ...
                        v: "20120214",
                        client_id: "HLNKAGBPDMZFBBTSIVMFXNZXW2XTEWOKGMDITE0UGH5RKVX4",
                        client_secret: "HDCAZKOOKJIGSXNVUEKQZE02CXHDR2043QQY2CLWURZ42LLJ",
                        query: request.term
                    },
                    success: function (data) {
                        ...
                        response($.map(data.response.venues, function (item) {
                            return {
                                name: item.name,
                                id: item.id,
